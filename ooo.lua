...
OrionLib:MakeNotification({
	Name = "云中心脚本",
	Content = "正在加载 云中心脚本-忍者传奇",
	Image = "rbxthumb://type=Asset&id=5107182114&w=150&h=150",
	Time = 5
})

local Window = OrionLib:MakeWindow({Name = "云中心脚本-忍者传奇", HidePremium = false, SaveConfig = true, IntroText = "云中心脚本-忍者传奇", ConfigFolder = "BeiFengNinjaLegends"})
